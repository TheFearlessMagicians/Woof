...
io.on('connection', function(socket) {
            ...
            socket.on('POSITION_RECEIVED', function(latLng) {
                    ...
                    // Dog.find({
                    //         "geo.lng": { "$gt": coordinates[0] - 1, "$lt": coordinates[0] + 1 },
                    //         'geo.lat': { "$gt": coordinates[1] - 1, "$lt": coordinates[1] + 1 },
                    //     }).limit(10).exec(function(error, foundDogs) {
                    //         if (error) {
                    //             console.log(error);
                    //         } else {
                    ...
                    Dog.find({}).sort([['delta','ascending']]).exec(function(error, sortedDogs){
                      if (error){
                        console.log(error);
                      } else {
